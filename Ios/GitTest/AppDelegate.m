...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    RootViewController *mainView = [[RootViewController alloc] init];
    [self.window setRootViewController:mainView];
    
    UINavigationController *myNavController = [[UINavigationController alloc] initWithRootViewController:mainView] ;
